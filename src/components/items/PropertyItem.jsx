        ...
        <>
            ...
            >
                <div className="property-item__thumb">
                    <Link to={propertyURL} state={{ thumb, title, desc, price, location, dataStatuses, dataLocations, dataTypes}} className="link">
                ...
                <div className="property-item__content">    
                    ...
                    <h6 className="property-item__title"> 
                        <Link to={propertyURL} state={{ thumb, title, desc, price, location, dataStatuses, dataLocations, dataTypes}} className="link">{title}</Link> 
                    </h6>
                    ...
                    <div className="property-item__bottom flx-between gap-2">
                        ...
                        {
                            btnRenderRight && (
                                <Link to={propertyURL} state={{ thumb, title, desc, price, location, dataStatuses, dataLocations, dataTypes}} className={`simple-btn ${btnClass}`}>
                                    {btnText}
